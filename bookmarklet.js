...
(async () => {
  ...
  globalStyle.textContent = `
    ...
    .dole-reaction-badge { display:inline-flex; align-items:center; gap:3px; padding:2px 7px; border-radius:999px; font-size:13px; cursor:pointer; border:1px solid rgba(255,255,255,0.08); background:rgba(255,255,255,0.03); }
  ...
  loginBox.innerHTML = `
    ...
    <div style="padding:4px 20px 24px; display:flex; flex-direction:column; gap:12px;">
      <input id="loginUser" class="dole-input" placeholder="Username" style="padding:14px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); outline:none; font-size:15px; background:rgba(0,0,0,0.2); color:#fff;">
      <input id="loginPass" class="dole-input" type="password" placeholder="Password" style="padding:14px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); outline:none; font-size:15px; background:rgba(0,0,0,0.2); color:#fff;">
      <div style="display:flex; gap:10px; margin-top:4px;">
        <button id="loginBtn" class="dole-btn" style="flex:1; padding:14px; border-radius:12px; border:none; background:linear-gradient(135deg,#5865f2,#4752c4); color:white; cursor:pointer; font-size:14px; font-weight:700; min-height:44px;">Login</button>
        <button id="createBtn" class="dole-btn" style="flex:1; padding:14px; border-radius:12px; border:none; background:linear-gradient(135deg,#2f855a,#276749); color:white; cursor:pointer; font-size:14px; font-weight:700; min-height:44px;">Create</button>
      </div>
  ...
  async function initChat(token, username) {
    ...
    box.innerHTML = `
      <div id="chatHeader" style="padding:12px 14px; background:linear-gradient(180deg,#16171f,#12131a); font-weight:600; position:relative; font-size:15px; display:flex; align-items:center; gap:8px; border-bottom:1px solid rgba(255,255,255,0.04); cursor:grab; user-select:none; flex-shrink:0;">
        <button id="minifyChat" title="Minimize" class="dole-btn" style="background:rgba(255,255,255,0.05); border:none; color:#9fb0e6; width:34px; height:34px; border-radius:10px; cursor:pointer; font-size:14px; display:flex; align-items:center; justify-content:center; min-height:44px;">_</button>
        ...
        <button id="pfpBtn" title="Profile Picture" class="dole-btn" style="background:rgba(88,101,242,0.15); color:#9fb0e6; border:none; width:34px; height:34px; border-radius:10px; cursor:pointer; font-size:16px; display:flex; align-items:center; justify-content:center; min-height:44px;">👤</button>
        <button id="callBtn" title="Call" class="dole-btn" style="background:linear-gradient(135deg,#2f855a,#276749); color:white; border:none; width:34px; height:34px; border-radius:10px; cursor:pointer; font-size:16px; display:flex; align-items:center; justify-content:center; min-height:44px;">📞</button>
        <button id="closeChat" class="dole-btn" style="background:rgba(255,107,107,0.15); color:#fc8181; border:none; width:34px; height:34px; border-radius:10px; cursor:pointer; font-size:13px; display:flex; align-items:center; justify-content:center; min-height:44px;">✕</button>
      </div>
      ...
      <div style="padding:8px 12px; display:flex; gap:8px; align-items:center; background:rgba(0,0,0,0.15); border-bottom:1px solid rgba(255,255,255,0.03); flex-shrink:0;">
        <button id="openRoomsBtn" class="dole-btn" style="padding:7px 14px; border-radius:8px; border:none; background:rgba(47,133,90,0.2); color:#68d391; cursor:pointer; font-size:12px; font-weight:600; min-height:40px;">🏠 Rooms</button>
        <button id="openExploreBtn" class="dole-btn" style="padding:7px 14px; border-radius:8px; border:none; background:rgba(43,108,176,0.2); color:#63b3ed; cursor:pointer; font-size:12px; font-weight:600; min-height:40px;">🔍 Explore</button>
        <div id="currentRoomDisplay" style="font-size:12px; color:#7289da; margin-left:auto; font-weight:500; background:rgba(88,101,242,0.1); padding:4px 10px; border-radius:6px;"># friends</div>
      </div>
      ...
      <div id="imageInputRow" style="display:none; padding:8px 10px; background:rgba(0,0,0,0.2); gap:8px; align-items:center; flex-shrink:0; flex-direction:row; border-top:1px solid rgba(255,255,255,0.04);">
        <input id="imageUrlInput" class="dole-input" placeholder="Paste image URL..." style="flex:1; padding:8px 12px; border-radius:8px; border:1px solid rgba(255,255,255,0.06); outline:none; font-size:14px; background:rgba(0,0,0,0.3); color:#fff;">
      ...
      <div style="padding:10px 12px; background:rgba(0,0,0,0.2); display:flex; gap:8px; align-items:center; border-top:1px solid rgba(255,255,255,0.04); flex-shrink:0;">
        <button id="imageBtn" title="Add image" class="dole-btn" style="padding:6px 8px; border-radius:8px; border:none; background:rgba(43,108,176,0.2); color:#63b3ed; cursor:pointer; font-size:16px; min-height:40px;">🖼️</button>
        <input id="chatInput" class="dole-input" style="flex:1; padding:10px 14px; border-radius:10px; border:1px solid rgba(255,255,255,0.06); outline:none; font-size:14px; background:rgba(0,0,0,0.3); color:#fff;">
        <button id="chatSend" class="dole-btn" style="padding:10px 16px; border-radius:10px; border:none; background:linear-gradient(135deg,#5865f2,#4752c4); color:white; cursor:pointer; font-size:14px; font-weight:700; min-height:40px;">Send</button>
      </div>
    `;
    ...
    pfpPanel.innerHTML = `
      ...
      <div id="pfpPreview" style="width:80px; height:80px; border-radius:50%; overflow:hidden; border:2px solid rgba(88,101,242,0.4); display:flex; align-items:center; justify-content:center; background:#1a1b1e; color:#999; font-size:32px; font-weight:700;"></div>
      <input id="pfpUrlInput" class="dole-input" placeholder="Paste image URL..." style="width:100%; max-width:280px; padding:12px 14px; border-radius:10px; border:1px solid rgba(255,255,255,0.08); outline:none; font-size:14px; background:rgba(0,0,0,0.2); color:#fff;">
      <div style="display:flex; gap:10px; flex-wrap:wrap; justify-content:center;">
        <button id="pfpUploadBtn" class="dole-btn" style="padding:10px 16px; border-radius:10px; border:none; background:#2b6cb0; color:#fff; cursor:pointer; font-size:13px; font-weight:600; min-height:40px;">Upload Image</button>
        <button id="pfpSaveBtn" class="dole-btn" style="padding:10px 16px; border-radius:10px; border:none; background:linear-gradient(135deg,#5865f2,#4752c4); color:#fff; cursor:pointer; font-size:13px; font-weight:600; min-height:40px;">Save</button>
        <button id="pfpRemoveBtn" class="dole-btn" style="padding:10px 16px; border-radius:10px; border:none; background:rgba(255,107,107,0.2); color:#fc8181; cursor:pointer; font-size:13px; font-weight:600; min-height:40px;">Remove</button>
      </div>
      <button id="pfpCloseBtn" class="dole-btn" style="padding:8px 14px; border-radius:8px; border:none; background:rgba(255,255,255,0.08); color:#aaa; cursor:pointer; font-size:13px; min-height:40px;">Cancel</button>
    ...
    function showCallWindow(peerName, lStream) {
      ...
      callWindow.innerHTML = `
        <div id="callHeader" style="padding:12px 16px; background:rgba(0,0,0,0.3); display:flex; align-items:center; gap:10px; cursor:grab; user-select:none; flex-shrink:0; border-bottom:1px solid rgba(255,255,255,0.04);">
          ...
          <button id="callCloseBtn" class="dole-btn" style="background:rgba(255,255,255,0.06); border:none; width:34px; height:34px; border-radius:10px; cursor:pointer; color:#9fb0e6; font-size:13px; display:flex; align-items:center; justify-content:center; min-height:44px;">✕</button>
        </div>
        <div style="flex:1; position:relative; background:#000; overflow:hidden;">
          <video id="remoteVideo" autoplay muted playsinline style="width:100%; height:100%; object-fit:cover; display:block;"></video>
          <video id="localVideo" autoplay muted playsinline style="position:absolute; bottom:14px; right:14px; width:120px; height:90px; object-fit:cover; border-radius:12px; border:2px solid rgba(255,255,255,0.15);"></video>
          <div id="callWaiting" style="position:absolute; inset:0; display:flex; flex-direction:column; align-items:center; justify-content:center; gap:16px; color:#e6eefc; background:radial-gradient(circle, rgba(88,101,242,0.1), rgba(0,0,0,0.6)); z-index:5;">
            <div style="width:72px; height:72px; border-radius:50%; background:linear-gradient(135deg,#5865f2,#4752c4); display:flex; align-items:center; justify-content:center; font-size:32px; box-shadow:0 8px 24px rgba(88,101,242,0.4);">📞</div>
            <div style="font-size:15px; opacity:0.7; font-weight:500;">Waiting for ${escapeHtml(peerName)}...</div>
          </div>
          <button id="unmuteRemote" class="dole-btn" style="display:none; position:absolute; top:50%; left:50%; transform:translate(-50%,-50%); padding:12px 20px; background:rgba(0,0,0,0.7); border:none; color:#fff; border-radius:12px; cursor:pointer; font-size:16px; font-weight:600; z-index:6; min-height:44px;">
            🔊 Tap to hear audio
          </button>
        </div>
        ...
        <div style="padding:16px; background:rgba(0,0,0,0.3); display:flex; gap:12px; justify-content:center; align-items:center; flex-shrink:0; border-top:1px solid rgba(255,255,255,0.04);">
          <button id="callMuteBtn" class="dole-btn" style="width:52px; height:52px; border-radius:50%; border:none; background:rgba(255,255,255,0.08); color:#fff; font-size:20px; cursor:pointer; display:flex; align-items:center; justify-content:center;">🎙️</button>
          <button id="callVideoBtn" class="dole-btn" style="width:52px; height:52px; border-radius:50%; border:none; background:rgba(255,255,255,0.08); color:#fff; font-size:20px; cursor:pointer; display:flex; align-items:center; justify-content:center;">📷</button>
          <button id="callDeafenBtn" class="dole-btn" style="width:52px; height:52px; border-radius:50%; border:none; background:rgba(255,255,255,0.08); color:#fff; font-size:20px; cursor:pointer; display:flex; align-items:center; justify-content:center;">🔈</button>
          <button id="callEndBtn" class="dole-btn" style="width:64px; height:64px; border-radius:50%; border:none; background:linear-gradient(135deg,#e53e3e,#c53030); color:#fff; font-size:24px; cursor:pointer; display:flex; align-items:center; justify-content:center;">📵</button>
        </div>
      `;
    ...
    incomingBanner.innerHTML = `
      <div style="width:56px; height:56px; border-radius:50%; background:linear-gradient(135deg,#2f855a,#276749); display:flex; align-items:center; justify-content:center; font-size:26px; box-shadow:0 4px 16px rgba(47,133,90,0.5);">📞</div>
      ...
      <div style="display:flex; gap:12px; width:100%; justify-content:center; margin-top:4px;">
        <button id="acceptCallBtn" class="dole-btn" style="flex:1; max-width:140px; padding:14px; border-radius:12px; border:none; background:linear-gradient(135deg,#48bb78,#38a169); color:#1a202c; font-weight:700; cursor:pointer; font-size:14px; min-height:44px;">Accept</button>
        <button id="rejectCallBtn" class="dole-btn" style="flex:1; max-width:140px; padding:14px; border-radius:12px; border:none; background:linear-gradient(135deg,#fc8181,#e53e3e); color:#1a202c; font-weight:700; cursor:pointer; font-size:14px; min-height:44px;">Reject</button>
      </div>
    `;
    ...
    modal.innerHTML = `
      ...
      <div style="display:flex; gap:8px; margin-top:auto;">
        <input id="newRoomNameInput" placeholder="New room name" style="flex:1; padding:10px; border-radius:10px; border:1px solid rgba(255,255,255,0.03); outline:none; font-size:14px; background:#0c0d10; color:#fff;">
        <button id="addRoomBtn" style="padding:10px 12px; border-radius:10px; border:none; background:#2f855a; color:white; cursor:pointer; min-height:40px;">Add</button>
        <button id="addAndSwitchBtn" style="padding:10px 12px; border-radius:10px; border:none; background:#2b6cb0; color:white; cursor:pointer; min-height:40px;">Add+Switch</button>
      </div>
    `;
    ...
    passwordModal.innerHTML = `
      ...
      <div style="display:flex; flex-direction:column; gap:8px;">
        <input id="pwdInput" type="password" placeholder="Room password" class="dole-input" style="padding:12px 14px; border-radius:10px; border:1px solid rgba(255,255,255,0.06); outline:none; font-size:14px; background:rgba(0,0,0,0.2); color:#fff;">
        ...
        <div style="display:flex; gap:8px; margin-top:4px;">
          <button id="pwdSubmit" class="dole-btn" style="flex:1; padding:12px; border-radius:10px; border:none; background:linear-gradient(135deg,#2f855a,#276749); color:white; cursor:pointer; font-weight:600; font-size:14px; min-height:40px;">Submit</button>
          <button id="pwdCancel" class="dole-btn" style="flex:1; padding:12px; border-radius:10px; border:none; background:rgba(255,255,255,0.08); color:#aaa; cursor:pointer; font-weight:600; font-size:14px; min-height:40px;">Cancel</button>
        </div>
      </div>
    `;
    ...
    function renderRoomsList() {
      ...
      for (const r of rooms) {
        ...
        if (!claimedInfo || !claimedInfo.claimed_by) {
          ...
          Object.assign(claimBtn.style, { padding: "6px 8px", borderRadius: "8px", border: "none", background: "#2f855a", color: "#fff", cursor: "pointer", fontSize: "12px", minHeight: "40px" });
          ...
          if (owner === username) {
            ...
            Object.assign(manageBtn.style, { padding: "6px 8px", borderRadius: "8px", border: "none", background: "#5865f2", color: "#fff", cursor: "pointer", fontSize: "12px", minHeight: "40px" });
            manageBtn.onclick = () => {
              ...
              Object.assign(change.style, { padding: "6px 8px", borderRadius: "8px", border: "none", background: "#2f855a", color: "#fff", cursor: "pointer", fontSize: "12px", minHeight: "40px" });
              const unclaim = document.createElement("button");
              unclaim.textContent = "Unclaim";
              Object.assign(unclaim.style, { padding: "6px 8px", borderRadius: "8px", border: "none", background: "#a33", color: "#fff", cursor: "pointer", fontSize: "12px", minHeight: "40px" });
        ...
        Object.assign(del.style, { padding: "6px 8px", borderRadius: "8px", border: "none", background: "#666", color: "#fff", cursor: "pointer", fontSize: "12px", minHeight: "40px" });
    ...
    async function showExploreOverlay() {
      try {
        ...
        header.innerHTML = `
          ...
          <button id="exploreClose" style="background:#333; border:none; padding:7px 12px; border-radius:8px; cursor:pointer; color:#fff; font-size:13px; min-height:40px;">Close</button>
        `;
        ex.appendChild(header);

        const searchRow = document.createElement("div");
        Object.assign(searchRow.style, { padding: "10px 14px 6px", flexShrink: "0", background: "#111214" });
        searchRow.innerHTML = `<input id="exploreSearch" placeholder="Search rooms..." style="width:100%; box-sizing:border-box; padding:10px 12px; border-radius:10px; border:1px solid rgba(255,255,255,0.06); outline:none; font-size:14px; background:rgba(0,0,0,0.3); color:#fff;">`;
        ...
        function renderExploreList() {
          ...
          for (const r of sorted) {
            ...
            Object.assign(joinBtn.style, { padding: "10px 14px", borderRadius: "8px", border: "none", background: "#5865f2", color: "#fff", cursor: "pointer", fontSize: "13px", fontWeight: "600", minHeight: "40px" });
    ...
    function addLocalTile() {
      if (!groupCallWindow) return;
      const grid = groupCallWindow.querySelector("#gcVideoGrid");
      if (grid.querySelector("#tile-local
